...
export default class Stats {
  ...
  setRenderPanel(_content) {
    this.render = {};
    this.render.content = _content;
    this.render.extension = this.render.content.getExtension(
  ...
  afterRender() {
    ...
    if (this.queryCreated) {
      this.render.content.endQuery(this.render.extension.TIME_ELAPSED_EXT);
    }
  }
